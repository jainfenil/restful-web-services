...
/*
* Factors to consider which method should we use for versioning
* URI Pollution
* Misuse of HTTP headers
* Caching
* Can we execute the request on te browser?
* API documentation
* */
...
public class PersonVersioningController {
    ...
    This is also called as "accept header" or "content negotiation"
     */
